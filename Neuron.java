...
public class Neuron {
		...
		public static Random los = new Random();
	 	...
	 	public double eta = 0.10;            //wspó³czynik uczenia                 
	 	public double y = 0;     
	 	...
	 	public Neuron()
	 	{
	 		...
	 		x = new double[in][wymiar];          //20 przyk³adów
	 		w = new double[in+1];      		    //wag tyle co wejœæ+1   
	 	    outputs = new double[wymiar];       //20 wyjœæ
	 	    losujWagi();
